    ...
    $selector = $selector == 3 ? 4 : 2;
        ...
        switch ($selector){
            case 1:
                ...
                $html .= Utilisateur::hasLiked($user->email, $this->touite->id) ? '</a></div> <a href="?action=like&id='.$this->touite->id.'"><img id="unlike" src="ressources/Heart.png"></a></p></div>' : '</a></div> <a href="?action=like&id='.$this->touite->id.'"><img id="like" src="ressources/Heart.png"></a></p></div>';
            ...
            case 3:
                ...
                <a href="?action=display-touite&idTouite='.$this->touite->id.'"><p class="touite-content-full">'.$text.'</p><br>';
                $html .= $this->touite->photo != null ? '<img src="'.$this->touite->photo.'"></a>' : "";
                ...
                $html .= '</a></div> <div id="likes-counter"> <p class="number-likes">'. Touite::getLikes($this->touite->id) . ' Likes</p>';
                $html .= '</div></div>';
