...
class ActionInscription extends Action
{
    ...
    public function execute(): string
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            } catch (AuthException $e) { //si l'inscription echoue
                $html = "<p> ERROR</p>";
                header('location: ?action=inscription');//on renvoie l'utilisateur sur la page d'inscription
            }

        } else { //si c'est une requete GET on affiche le formulaire d'inscription
