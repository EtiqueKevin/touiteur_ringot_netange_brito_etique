...
function eml_aff_formulaire(array $err): void {
    ...
    echo 
                ...
                '</table>',
            '</form>',
            '<br>Déjà inscrit(e),<a href="./index.php"> connectez-vous</a>.</aside>';
}
...
function eml_traitement_inscription(): array {
    ...
    header('Location: compte.php?pseudo='.$pseudo); //TODO : à modifier dans le projet
    exit();
}
